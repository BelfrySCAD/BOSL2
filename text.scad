...
//   $refchar_width = Reference character for `letterspace_ref`. Default: "0" (zero)
// Named Anchors:
...
_stylecodes = [    // style codes in text. The index of the array is used to identify the style
    "{{r}}",    // 0 = Regular
    "{{i}}",    // 1 = Italic
    "{{b}}",    // 2 = Bold
    "{{bi}}"    // 3 = Bold Italic
